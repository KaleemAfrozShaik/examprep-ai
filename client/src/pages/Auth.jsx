...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen overflow-hidden bg-white text-black px-8">
      ...
      rounded-2xl bg-black/80 backdrop-blur-xl border border-white/10 px-8 py-6 shadow-[0_20px_45px_rgba(0,0,0,0.6)] ">
        <h1 className="text-2xl font-bold bg-linear-to-r from-white via-gray-300 to-white bg-clip-text text-transparent">ExamPrep AI</h1>
      ...
      transition={{duration:0.7}}>
          <h1 className="text-5xl lg:text-6xl font-extrabold leading-tight bg:gradient-to-br from-black/90 via-black/60 to-black/90 bg-clip-text">
          ...
          transition={{type:"spring",stiffness:200,deeping:18}}
          className='mt-10 px-10 py-3 rounded-xl flex items-center gap-3 bg-linear-to-br from-black/90 via-black/80 to-black/90 border border-white/10 text-white font-semibold text-lg shadow-[0_25px_60px_rgba(0,0,0,0.5)]'
          onClick={handleClick}>
            Get Started
            <BiLogIn />
          </motion.button>
