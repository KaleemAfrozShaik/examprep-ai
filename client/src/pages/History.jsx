          ...
          {isSidebarOpen && (
            ...
            >
              ...
              <div className="mb-4 space-y-1">
                ...
                >
                  <span className="font-semibold text-xl">+</span> New Notes
                </button>
        ...
        >
          ...
          <div className="relative">
             ...
             <motion.div
                ...
                className="w-12 h-12 bg-white/5 border border-white/10 rounded-xl flex items-center justify-center relative z-10"
             >
                <div className="w-4 h-4 rounded bg-indigo-500/50 animate-pulse" />
             </motion.div>
          </div>
